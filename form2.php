      ...
      <form action="form2.php" method="POST" enctype="multipart/form-data">
        <div class="row">
          <div class="col-md-9">
            ...
            <input type="text" class="form-control" name="nm_curso" placeholder="Ex.Ensino Técnico Integardo ao Médio"
            />
          </div>
          <div class="col-md-3">
            <label for="dt_ano_conclusao" class="campo">Ano de Conclusão:</label>
            <input type="number"class="form-control"name="dt_ano_conclusao"placeholder="Ex.2020"
            />
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-9">
            ...
            <input type="text"class="form-control"name="nm_instituicao"placeholder="Ex,: ETEC de Peruíbe"
            />
          </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <input type="text"class="form-control"name="nm_empresa" placeholder="Ex.:Bradesco"
            />
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
            ...
            <input type="text"class="form-control"name="cargo"placeholder="Ex.:Professor..."
            />
          </div>
          <div class="col-md-3">
            <label for="dt_inicio" class="campo">Início em: </label>
            <input type="text"  class="form-control" name="dt_inicio"placeholder="Ex.:2019"
            />
          </div>
          <div class="col-md-3">
            <label for="dt_fim" class="campo">Fim em: </label>
            <input type="text" class="form-control" name="dt_fim" placeholder="Ex.:2020"
            />
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-9">
            ...
            <input type="text" class="form-control" name="funcao_cargo" placeholder="Ex.:Lavava,cozinhava..."
            />
          </div>
          <div class="col-md-3 mt-4">
